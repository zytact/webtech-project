      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
        {columns.map((column) => (
          ...
          >
            ...
            <ul className="space-y-4" aria-label={`${column.title} tasks`}>
              {column.tasks.map((task) => (
                <li key={task.id} className="list-none">
                  <Card className="border bg-white/60 backdrop-blur-sm transition-all duration-300 hover:bg-white/70 dark:bg-neutral-800/60 dark:hover:bg-neutral-700/70">
