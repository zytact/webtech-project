...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all " +
    ...
    "shrink-0 [&_svg]:shrink-0 outline-none focus-visible:ring-[3px] focus-visible:ring-ring/50 " +
    "focus-visible:border-ring aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 " +
...
/**
 * Accessible and type-safe Button component.
 */
function Button({
  className,
  variant,
  ...
  return (
    <Comp
      // ✅ Always enforce explicit button type
